            ...
            <div className={styles.coverBody}>
              ...
              <div className={styles.coverTextCol} data-depth-text>
                ...
                <p className={styles.coverStatement}>
                  Menus, orders and reservations built into one clear customer experience.
                </p>

                {/* What I Provide Deliverables List */}
                <div className={styles.deliverablesList}>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>DIGITAL MENU</span>
                    <span className={styles.deliverableDesc}>Clear mobile-friendly menus</span>
                  </div>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>ONLINE ORDERS</span>
                    <span className={styles.deliverableDesc}>Direct ordering flow</span>
                  </div>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>RESERVATIONS</span>
                    <span className={styles.deliverableDesc}>Simple table booking</span>
                  </div>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>PROMOTIONS</span>
                    <span className={styles.deliverableDesc}>Offers, events and updates</span>
                  </div>
                </div>
          ...
          >
            ...
            <div className={styles.coverBody}>
              ...
              <div className={styles.coverTextCol} data-depth-text>
                ...
                <p className={styles.coverStatement}>
                  A clear professional website that explains your business and makes it easy to get in touch.
                </p>
                ...
                <div className={styles.deliverablesList}>
                  <div className={styles.deliverableItem}>
                    ...
                    <span className={styles.deliverableDesc}>Present what you offer</span>
                  </div>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>WORK</span>
                    <span className={styles.deliverableDesc}>Show projects and experience</span>
                  </div>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>ENQUIRIES</span>
                    <span className={styles.deliverableDesc}>Turn visitors into leads</span>
                  </div>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>CONTACT</span>
                    <span className={styles.deliverableDesc}>Make communication simple</span>
                  </div>
                </div>
                ...
                <div className={styles.businessVisualContainer}>
                  ...
                  <div className={styles.bizBoardMain} data-depth-elem="biz-board-main">
                    ...
                    <div className={styles.bizBoardSections}>
                      <div className={styles.bizSectionItem}>
                        ...
                        <span className={styles.bizSectionDesc}>Present what you offer</span>
                      ...
                      <div className={styles.bizSectionItem}>
                        ...
                        <span className={styles.bizSectionDesc}>Show projects and experience</span>
                        <div className={styles.bizSectionRule} />
                      </div>
                      <div className={styles.bizSectionItem}>
                        <div className={styles.bizSectionLabelRow}>
                          <span className={styles.bizSectionIndex}>03</span>
                          <span className={styles.bizSectionTitle}>ENQUIRIES</span>
                        </div>
                        <span className={styles.bizSectionDesc}>Turn visitors into leads</span>
                        <div className={styles.bizSectionRule} />
                      </div>
                      <div className={styles.bizSectionItem}>
                        <div className={styles.bizSectionLabelRow}>
                          <span className={styles.bizSectionIndex}>04</span>
                          <span className={styles.bizSectionTitle}>CONTACT</span>
                        </div>
                        <span className={styles.bizSectionDesc}>Make communication simple</span>
                        <div className={styles.bizSectionRule} />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={styles.bizBoardSecondary} data-depth-elem="biz-board-secondary">
                    <div className={styles.bizSecHeader}>
                      <span className={styles.bizSecTag}>PROJECT SURFACE</span>
                  ...
                  {/* Foreground Enquiry Element */}
                  <div className={styles.bizInquirySlip} data-depth-elem="biz-inquiry-card">
                    <div className={styles.bizInquiryHeader}>
                      <span className={styles.bizInquiryTag}>NEW ENQUIRY</span>
                      <span className={styles.bizInquiryDot} />
                    </div>
                    <span className={styles.bizInquiryAction}>Project Consultation</span>
                    <span className={styles.bizInquirySub}>Turn visitors into leads →</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className={styles.coverBody}>
              ...
              <div className={styles.coverTextCol} data-depth-text>
                ...
                <p className={styles.coverStatement}>
                  A product-focused shopping experience with clear browsing, cart and checkout flows.
                </p>
                ...
                <div className={styles.deliverablesList}>
                  <div className={styles.deliverableItem}>
                    ...
                    <span className={styles.deliverableDesc}>Organised product browsing</span>
                  </div>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>PRODUCT PAGES</span>
                    <span className={styles.deliverableDesc}>Clear product information</span>
                  </div>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>CART &amp; CHECKOUT</span>
                    <span className={styles.deliverableDesc}>Simple purchase flow</span>
                  </div>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>PROMOTIONS</span>
                    <span className={styles.deliverableDesc}>Featured products and offers</span>
                  </div>
                </div>
          ...
          >
            ...
            <div className={styles.coverBody}>
              ...
              <div className={styles.coverTextCol} data-depth-text>
                ...
                <p className={styles.coverStatement}>
                  Let customers explore your services, check availability and book without unnecessary back-and-forth.
                </p>
                ...
                <div className={styles.deliverablesList}>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>SERVICES</span>
                    <span className={styles.deliverableDesc}>Clear service options</span>
                  </div>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>AVAILABILITY</span>
                    <span className={styles.deliverableDesc}>Open dates and times</span>
                  </div>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>BOOKINGS</span>
                    <span className={styles.deliverableDesc}>Simple scheduling</span>
                  </div>
                  <div className={styles.deliverableItem}>
                  ...
                  <div className={styles.bookClock} data-depth-elem="book-clock">
                    <div className={styles.clockBezel}>
                      <div className={styles.clockFace}>
                        ...
                        <span className={styles.clockSecondHand} />
        ...
        <div className={styles.valueContent} data-depth-content>
          <div className={styles.valueBody} data-depth-text>
            ...
            <p className={styles.valueStatement} data-depth-val-copy>
              Everything is built around how your business actually works — from customer journeys to the tools you need behind the scenes.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className={styles.ctaSection} data-depth-cta id="websites-cta" aria-label="Start your website project">
        <div className={styles.ctaContent} data-depth-content>
          <div className={styles.ctaHead} data-depth-text>
            ...
            <p className={styles.ctaCopy} data-depth-cta-copy>Tell me what you need and I’ll help you shape the right website for it.</p>
          </div>
