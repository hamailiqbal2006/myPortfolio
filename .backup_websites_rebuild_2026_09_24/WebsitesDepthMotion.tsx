    ...
    const context = gsap.context(() => {
      media.add(
        ...
        (context) => {
          ...
          // Restrained living depth: lines travel at distinct Z/Y rates.
          // ==================================================
          if (hero) {
            ...
            if (line1) {
              heroTl.to(line1, { yPercent: isMobile ? -6 : -11, z: isMobile ? -30 : -75, opacity: 0.8 }, 0);
            }
            if (line2) {
              heroTl.to(line2, { yPercent: isMobile ? -9 : -16, z: isMobile ? -45 : -120, opacity: 0.7 }, 0);
            }
            if (copy) {
              heroTl.to(copy, { yPercent: isMobile ? -4 : -8, opacity: 0.6 }, 0);
            }
          }

          // ==================================================
          // 2. "WHAT CAN I BUILD FOR YOU?" TRANSITION
          // Bridges Hero into Covers with subtle opposing depth.
          // ==================================================
          if (transition) {
            ...
            if (transContent) {
              ...
              transTl.fromTo(
                transContent,
                { yPercent: isMobile ? 6 : 10, opacity: 0.8, z: isMobile ? -20 : -50 },
                { yPercent: 0, opacity: 1, z: 0, duration: 0.6 }
              );

              if (transLine1 && transLine2 && !isMobile) {
                transTl.fromTo(transLine1, { z: -35 }, { z: 15, duration: 0.6 }, 0);
                transTl.fromTo(transLine2, { z: -55 }, { z: -5, duration: 0.6 }, 0);
              }
            }
          }
