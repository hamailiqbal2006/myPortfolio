              ...
              <div className={styles.coverTextCol} data-depth-text>
                ...
                <div className={styles.deliverablesList}>
                  ...
                  <div className={styles.deliverableItem}>
                    ...
                    <span className={styles.deliverableDesc}>Turn visits into leads</span>
                  </div>
                  <div className={styles.deliverableItem}>
              ...
              <div className={styles.coverTextCol} data-depth-text>
                ...
                <div className={styles.deliverablesList}>
                  ...
                  <div className={styles.deliverableItem}>
                    ...
                    <span className={styles.deliverableDesc}>Simple appointment scheduling</span>
                  </div>
                  <div className={styles.deliverableItem}>
                    <span className={styles.deliverableLabel}>CONFIRMATION</span>
                    <span className={styles.deliverableDesc}>Clear booking details</span>
                  </div>
                </div>
