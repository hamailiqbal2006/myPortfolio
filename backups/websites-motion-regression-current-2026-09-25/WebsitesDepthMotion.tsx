    ...
    const context = gsap.context(() => {
      media.add(
        ...
        (mediaContext) => {
          ...
          covers.forEach((cover, index) => gsap.set(cover, { yPercent: index === 0 ? 0 : 106, zIndex: 4 - index, opacity: 1, rotateX: 0, z: 0, force3D: true }));
          ...
          sequence.to(restaurant, { yPercent: -106, duration: handoffDuration }, focalDuration).to(business, { yPercent: 0, duration: handoffDuration }, focalDuration);
          ...
          sequence.to(business, { yPercent: -106, duration: handoffDuration }, second + focalDuration).to(commerce, { yPercent: 0, duration: handoffDuration }, second + focalDuration);
          ...
          sequence.to(commerce, { yPercent: -106, duration: handoffDuration }, third + focalDuration).to(booking, { yPercent: 0, duration: handoffDuration }, third + focalDuration);
